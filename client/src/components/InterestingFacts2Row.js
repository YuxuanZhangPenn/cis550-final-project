	...
	render() {
		return (
			<div className="BestPicActorActressSameYear-results-container">
				...
				<div className="win3prize">{this.props.oscarWhichGenreGenre} </div>
				...
				<div className="win3prize">{this.props.goldenDirectorActortitle} </div>
				<div className="win3prize">{this.props.goldenDirectorActorName} </div>
			</div>
		);
	}
}